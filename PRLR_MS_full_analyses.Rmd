...
```{r hyp figures, eval=FALSE, message=FALSE, warning=FALSE}
...
print(bp.pit.prlr)
```
```{r pit figures, eval==FALSE, message=FALSE, warning=FALSE}
#only run once (eval set to false)
# paper-ready figures using cowplot
...
```{r crop figures, eval=FALSE, message=FALSE, warning=FALSE}
#only run once (eval set to false)
# paper-ready figures using cowplot
