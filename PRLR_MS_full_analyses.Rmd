...
sp.p.p.j<- p.p.j %>% ggplot(aes(y = log.exp, x = Prolactin.ng.mL, shape=stage))+
           geom_point(size = 3)+
...
sp.h.pr.j<- h.pr.j %>% ggplot(aes(y = log.exp, x = Prolactin.ng.mL, color=stage, shape=stage))+
           geom_point(size=3)+
          geom_smooth(method=lm, na.rm = TRUE, fullrange= TRUE,
              aes(group=1),colour="black") + 
          labs(x="Plasma prolactin concentration (ng/mL)", 
...
#plot correlation
#(scatterplot for hyp, prl, joined data) = sp.h.pr.j
sp.h.p.j<- h.p.j %>% ggplot(aes(y = log.exp, x = Prolactin.ng.mL, color=stage, shape=stage))+
           geom_point(size=3)+
          geom_smooth(method=lm, na.rm = TRUE, fullrange= TRUE,
              aes(group=1),colour="black") + 
          labs(x="Plasma prolactin concentration (ng/mL)", 
...
#plot correlation
#(scatterplot for hyp, prl, joined data) = sp.h.pr.j
sp.p.pr.j<- p.pr.j %>% ggplot(aes(y = log.exp, x = Prolactin.ng.mL, color=stage, shape=stage))+
           geom_point(size=3)+
          geom_smooth(method=lm, na.rm = TRUE, fullrange= TRUE,
              aes(group=1),colour="black") + 
          labs(x="Plasma prolactin concentration (ng/mL)", 
          ...
          annotate("text", x = 75, y = 3, label = "n.s.", size=5)
sp.p.pr.j
