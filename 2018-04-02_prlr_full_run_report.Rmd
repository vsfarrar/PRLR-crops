...
prlr<-read.csv(file="~/Documents/2018-04-03_PRLR_project_results.csv")
...
#outlier analysis for prolactin data
qqPlot(f2, main="QQ Plot")  #looks ok
influencePlot(f2,	id.method="identify", main="Influence Plot", sub="Circle size is proportial to Cook's Distance" ) 
#large circles outside the boundary of -2 to 2 are outliers 


# Cook's D plot
# identify D values > 4/(n-k-1) 
cutoff <- 4/((nrow(prlr)-length(f2$coefficients)-2)) 
